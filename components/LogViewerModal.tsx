    ...
    >
      ...
      >
        <header className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
          <h2 id="log-viewer-title" className="text-xl font-bold text-cyan-500 dark:text-cyan-400">
            Application Logs
          </h2>
        ...
        <main className="flex-grow p-4 overflow-y-auto" tabIndex={0} role="region" aria-label="Log entries">
          {logs.length === 0 ? (
            ...
            <ul className="space-y-2 font-mono text-sm" role="list">
              {logs.map((log, index) => (
                <li
                  ...
                  className="p-2 rounded-md bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700"
                  tabIndex={0}
                >
